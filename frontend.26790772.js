...
},{}],"jP58":[function(require,module,exports) {
"use strict";
...
function Navbar(_ref) {
  ...
  var navStyles = "flex items-center h-full px-1 sm:px-3 lg:px-5 hover:bg-gray-500 text-gray-300 font-semibold text-lg";

  var logIn = /*#__PURE__*/_react.default.createElement("button", {
    onClick: onLogin,
    className: navStyles
  }, "Log in");

  var logOut = /*#__PURE__*/_react.default.createElement("div", {
    key: 0,
    className: "flex justify-center h-full"
  }, /*#__PURE__*/_react.default.createElement("button", {
    onClick: onMint,
    className: navStyles + " mx-4 hover:bg-green-500 bg-green-600"
  }, "Mint tokens"), /*#__PURE__*/_react.default.createElement("button", {
    onClick: onLogout,
    className: navStyles
  }, "Log out"));

  var displayName = /*#__PURE__*/_react.default.createElement("div", {
    key: 1,
    className: navStyles
  }, currentUser === null || currentUser === void 0 ? void 0 : currentUser.accountId);
  ...
  return /*#__PURE__*/_react.default.createElement("nav", {
    ...
    className: "flex flex-row-reverse items-center justify-between h-16"
  }, currentUser ? [logOut, displayName] : logIn)));
}
},{"react":"n8MK"}],"gBZ8":[function(require,module,exports) {
"use strict";
...
function Token(_ref) {
  ...
  var getColour = function getColour(object, index) {
    var previousColour = Object.keys(object)[index - 1] ? object[Object.keys(object)[index - 1]] : 0;
    var currentColour = object[Object.keys(object)[index]];
    var nextColour = Object.keys(object)[index + 1] ? object[Object.keys(object)[index + 1]] : 0;
    return "rgb(".concat(previousColour, ", ").concat(currentColour, ", ").concat(nextColour, ")");
  };

  return /*#__PURE__*/_react.default.createElement("div", {
    className: "transition-all bg-black rounded-xl text-center text-dark-white w-64 p-2 my-4 text-bold flex flex-col justify-center items-center"
  }, token_id, /*#__PURE__*/_react.default.createElement("div", {
    className: "bg-gray-800 rounded-xl shadow-xl h-fit w-full flex flex-col items-center justify-center"
  }, metadata && Object.keys(metadata).map(function (key, index) {
    return /*#__PURE__*/_react.default.createElement("div", {
      key: index,
      className: "p-2 w-full text-white ".concat(!index ? "rounded-t-xl" : index === Object.keys(metadata).length - 1 ? "rounded-b-xl" : ""),
      style: {
        background: getColour(metadata, index),
...
},{"react":"n8MK"}],"f2yq":[function(require,module,exports) {
"use strict";
...
function Tokens(_ref) {
  ...
  var previousOn = pagination.previousOn,
      nextOn = pagination.nextOn,
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    className: "flex flex-col items-center justify-center mx-12 my-6"
  }, children, /*#__PURE__*/_react.default.createElement("div", {
    className: "flex flex-wrap justify-evenly w-full p-4"
  }, tokens.map(function (token, index) {
    return /*#__PURE__*/_react.default.createElement(_Token.default, {
      key: index,
      metadata: JSON.parse(token.extra),
    ...
    onClick: onPrevious,
    className: "flex items-center px-4 py-2 bg-gray-600 rounded-md ".concat(previousOn && !disabled ? "hover:bg-blue-700 text-white cursor-pointer font-bold bg-gray-600" : "text-gray-800 bg-gray-500 font-light")
  }, "Previous"), /*#__PURE__*/_react.default.createElement("div", {
    className: "px-4 py-2 mx-4 text-gray-700 bg-gray-500 rounded-md"
  }, pagination.page), /*#__PURE__*/_react.default.createElement("div", {
    onClick: onNext,
    className: "flex items-center px-4 py-2 bg-gray-700 rounded-md ".concat(nextOn && !disabled ? "hover:bg-blue-700 text-white cursor-pointer font-bold bg-gray-600" : "text-gray-800 bg-gray-500 font-light")
  }, "Next")));
}
},{"react":"n8MK","./Token":"gBZ8"}],"fDBh":[function(require,module,exports) {
...
},{"./v1":"hVVj","./v4":"hYHi"}],"lY9v":[function(require,module,exports) {
"use strict";
...
var MINTING_PRICE = (0, _big.default)(1).times(Math.pow(10, 23)) // One yNEAR is 10 ** 24 yoctoNEAR
.toFixed();
...
var App = function App(_ref) {
  ...
  var _useState = (0, _react.useState)(null),
      ...
      ownedTokens = _useState2[0],
      setOwnedTokens = _useState2[1];

  var _useState3 = (0, _react.useState)(null),
      _useState4 = _slicedToArray(_useState3, 2),
      allTokens = _useState4[0],
      setAllTokens = _useState4[1];
  ...
  var _useState5 = (0, _react.useState)({
    ...
    disabled: false
      ...
      ownedTokensPagination = _useState6[0],
      setOwnedTokensPagination = _useState6[1];
  ...
  var _useState7 = (0, _react.useState)({
    ...
    disabled: false
      ...
      allTokensPagination = _useState8[0],
      setAllTokensPagination = _useState8[1];

  var updateOwnedTokens = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var tokens, modifiedTokens;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              modifiedTokens = tokens.map(function (token) {
                return _objectSpread(_objectSpread({}, token.metadata), {}, {
                  token_id: token.token_id,
                  owner_id: token.owner_id
                });
              });
    ...
    return function updateOwnedTokens() {
      return _ref2.apply(this, arguments);
    };
  }();

  var updateAllTokens = /*#__PURE__*/function () {
    ...
    return function updateAllTokens() {
      return _ref3.apply(this, arguments);
    };
  }();

  var paginateOwnedTokens = /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(direction) {
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              setOwnedTokensPagination(_objectSpread(_objectSpread({}, ownedTokensPagination), {}, {
    ...
    return function paginateOwnedTokens(_x) {
      return _ref4.apply(this, arguments);
    };
  }();

  (0, _react.useEffect)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return updateOwnedTokens();
  ...
  var paginateAllTokens = /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(direction) {
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              setAllTokensPagination(_objectSpread(_objectSpread({}, allTokensPagination), {}, {
    ...
    return function paginateAllTokens(_x2) {
      return _ref6.apply(this, arguments);
    };
  }();

  (0, _react.useEffect)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
  ...
  (0, _react.useEffect)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
      ...
      return regeneratorRuntime.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              token_id = "token-".concat((0, _uuid.v4)());
              _context8.next = 3;
              return contract.nft_mint({
                token_id: token_id,
                receiver_id: currentUser.accountId
              }, BOATLOAD_OF_GAS, MINTING_PRICE // This represents the amount of NEAR paid for minting the token.
              );
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
  ...
  }), ownedTokens && /*#__PURE__*/_react.default.createElement(_Tokens.default, {
    ...
    className: "rounded-lg bg-zinc-500 text-3xl font-bold text-dark-white"
  }, "Your tokens")), allTokens && /*#__PURE__*/_react.default.createElement(_Tokens.default, {
...
},{"regenerator-runtime/runtime":"QVnC","react":"n8MK","big.js":"NYl1","./components/Navbar":"jP58","./components/Tokens":"f2yq","uuid":"qQO4"}],"itQ5":[function(require,module,exports) {
var CONTRACT_NAME = undefined || "nft.raresgeo.testnet";
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/home/runner", "/.near/validator_key.json"),
...
},{"./key_stores/browser-index":"TLlZ","./common-index":"gdw7","./browser-connect":"eFRj","error-polyfill":"C0cm"}],"hewo":[function(require,module,exports) {
"use strict";
...
},{"react-router":"LI7H","@babel/runtime/helpers/esm/inheritsLoose":"S11h","react":"n8MK","history":"Wop6","prop-types":"D9Od","tiny-warning":"sIbj","@babel/runtime/helpers/esm/extends":"SpjQ","@babel/runtime/helpers/esm/objectWithoutPropertiesLoose":"Vabl","tiny-invariant":"bfQg"}],"Focm":[function(require,module,exports) {
"use strict";
...
},{"react":"n8MK","react-dom":"NKHc","./App":"lY9v","./config.js":"itQ5","near-api-js":"mXyb","react-router-dom":"uc19"}]},{},["Focm"], null)
//# sourceMappingURL=frontend.26790772.js.map